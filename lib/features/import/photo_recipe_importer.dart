...
class PhotoRecipeImporter {
  PhotoRecipeImporter({TextRecognizer? textRecognizer})
  ...
  Future<RecipeInput> importFromImagePath(String imagePath) async {
    final String storedImagePath = await _copyImportImageToLocalStorage(
      imagePath,
    );
    ...
    try {
      ...
      extractedText = '';
      fallbackMessage =
          'OCR failed on this image. You can still edit manually.';
    }
  ...
  Future<String> _copyImportImageToLocalStorage(String imagePath) async {
